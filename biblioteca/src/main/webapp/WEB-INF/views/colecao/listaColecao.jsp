		...
		<table id="tabcolecoes" class="table table-striped"> 
			...
			<c:forEach var="colecao" items="${colecoes}">
				<tr>
					...
					<td style="text-align:center; width:10px;"> <sec:authorize access="@AlteracaoRegistroSecurityService.podeAlterar(#colecao)"><a href="<c:url value="/delColecao/${colecao.id}"/>" ><span title="Excluir" class="glyphicon glyphicon-remove" style="color:red"></span></a> </sec:authorize> </td>
