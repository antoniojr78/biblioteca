...
<a href="<c:url  value="${springBase}/cadLivro"/>">
		...
		<table id="tabLivros" class="table table-striped"> 
			...
			<c:forEach var="livro" items="${livros}">
				<tr>
					...
					<td style="text-align:center; width:10px;" ><c:if test="${podeAlterar }"><a href="<c:url value="${springBase}/editLivro/${livro.id}" />"><span title="Editar" class="glyphicon glyphicon-pencil" ></span></a> </c:if> </td>
...
<c:url value="${springBase}/delLivro" var="linkDel"/>
