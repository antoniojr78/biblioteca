...
<sec:authorize var="usuarioMaster" access="@AlteracaoRegistroSecurityService.isMaster(#usuario)" />

<h2 class="sub-header">Edição de Usuário</h2>
<div class="col-sm-6">
	<c:url value="${springBase}/editarUsuario" var="linkAct" />
	...
	<sf:form commandName="usuario" modelAttribute="usuario" action="${linkAct}"
		...
		<div class="form-group">
			...
			<div class="col-sm-10">  
				<sf:checkbox path="master"  id="inputMaster" disabled="${!usuarioMaster}" />
			</div>
		</div>			
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				...
				<a href="<c:url  value="${springBase}/listaUsuario"/>">
